...
export const metadata = {
  title: "Urgent Campaigns | Forestry Reserve",
  description:
    "Urgent action campaigns to respond to active forest and habitat crises.",
};
    ...
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="max-w-3xl mb-16">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed balance-text">
          Crisis requires immediate action. These campaigns represent our
          rapid-response efforts to wildfires, illegal logging, and critical
      ...
      <div className="flex flex-col gap-12">
        {campaigns.map((campaign) => (
          <div
            key={campaign.id}
            className="flex flex-col md:flex-row bg-card rounded-3xl overflow-hidden border border-border shadow-md hover:shadow-xl transition-shadow"
          >
            ...
            <div className="w-full md:w-7/12 p-8 lg:p-12 flex flex-col justify-center">
              ...
              <div className="flex gap-4">
                <Button
                  asChild
                  size="lg"
                  className="bg-destructive hover:bg-destructive/90 text-white w-full sm:w-auto h-12"
                >
