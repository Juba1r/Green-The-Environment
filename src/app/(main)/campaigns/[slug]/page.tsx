...
export async function generateMetadata({
  ...
  if (!campaign) return { title: "Not Found | Forestry Reserve" };
        ...
        <div className="bg-card border-none shadow-2xl rounded-3xl p-8 lg:p-12 mb-16 ring-1 ring-border">
          <div className="bg-muted p-6 rounded-2xl mb-10 flex flex-col md:flex-row items-center justify-between gap-6 border border-border">
            ...
            <Button
              asChild
              size="lg"
              className="w-full md:w-auto h-16 px-10 text-lg bg-destructive hover:bg-destructive/90 text-white rounded-2xl shadow-xl shadow-destructive/20 shrink-0"
            >
          ...
          <div
            className="prose prose-lg dark:prose-invert prose-headings:font-heading prose-p:leading-relaxed prose-a:text-destructive max-w-none"
