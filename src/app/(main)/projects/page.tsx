...
export const metadata = {
  title: "Our Projects | Forestry Reserve",
  description:
    "Detailed overview of active forest conservation and woodland restoration projects around the globe.",
};
  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="max-w-3xl mb-16">
        <h1 className="font-heading text-5xl md:text-6xl font-black mb-6 tracking-tight text-foreground">
          Global Projects
        </h1>
        <p className="text-xl text-muted-foreground leading-relaxed balance-text">
          Our conservation efforts span the globe, addressing deforestation,
          ecosystem rehabilitation, and species protection. We work directly
          with local forest guardians to ensure long-term, scalable impact.
        </p>
      </div>
          ...
          >
            <div className="relative aspect-video overflow-hidden">
              ...
              <div className="absolute top-4 left-4 bg-background/80 backdrop-blur-md px-3 py-1 rounded-full text-xs font-semibold text-foreground flex items-center gap-1 shadow-sm">
                ...
                {project.category === "Community Health" && (
                  <Leaf className="w-3 h-3 text-primary" />
                )}
                {project.category === "Marine Life" && (
